...
type morphology = 
  ...
  mutable qstate: quantum_state;   _associated_ with 'observables' *)
  }
  (* Quantum state for superposition collapse *)
  type quantum_state = 
  | Superposition of Complex.t array  (* Amplitude distribution *)
  | Entangled of byte_word list       (* Coupled state indices *)
  | Collapsed of byte_word            (* Definite state *)
